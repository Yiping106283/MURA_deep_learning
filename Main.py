...
def main():
    ...
    parser.add_argument('--pathtotrainmodel',default='best_BCE.dense.tar',help = 'path to model for train and val')
    parser.add_argument('--pathtosavemodel',default='best.dense.tar',help ='path to save model')
    parser.add_argument('--retrievalpath', default='image1.png', help = 'path to img for retrieval')
    parser.add_argument('--modelretrieval', default='model_retrieval.tar', help ='path to model for retrieval')    
